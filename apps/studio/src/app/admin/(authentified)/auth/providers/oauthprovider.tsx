...
export default function OAuthProvider({
	...
	return (
		<Card className="overflow-hidden">
			<CardHeader
				className="flex justify-between flex-row items-center py-2 cursor-pointer hover:bg-gray-100 transition"
			...
			>
				<div className="flex items-center gap-3">
					...
					<img src={metadata.logo} alt={name} className="h-6 max-w-6" />
			...
			{expanded && (
				<CardContent className="space-y-6 p-5">
					...
					<div>
						<label htmlFor="clientSecret" className="block text-sm font-medium text-zinc-700 mb-1">
